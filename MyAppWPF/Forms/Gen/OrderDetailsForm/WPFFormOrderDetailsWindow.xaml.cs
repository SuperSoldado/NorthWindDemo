...
using MyAppWPFLib;
    ...
    public partial class FormWPFOrderDetails : Page
    {    
        ...
        /// <summary>
        /// Load the form using table 'OrderDetails' PrimaryKey
        /// </summary>
        public void LoadForm(int OrderID,int ProductID)
        {            
            string error = null;
            OrderDetailsDataContext = dataConnection.GetDataContext(OrderID,ProductID, out error);
            DataContext = OrderDetailsDataContext;
        ...
        {    
            string error = null;
            var itemToSave = OrderDetailsDataContext.modelNotifiedForOrderDetailsMain;
        ...
        {
            PropertyInfo[] sourceListClassInfoProperties = typeof(ModelNotifiedForOrderDetails).GetProperties();
            foreach (PropertyInfo sourceProperty in sourceListClassInfoProperties)
            {
                sourceProperty.SetValue(OrderDetailsDataContext.modelNotifiedForOrderDetailsMain, null, null);
            }
        ...
        private void btnDelete_Click(object sender, RoutedEventArgs e)
        {
            ...
            switch (result)
            {
                case MessageBoxResult.Yes:
                    dataConnection.DeleteData(OrderDetailsDataContext.modelNotifiedForOrderDetailsMain, out error);
                    break;
