...
namespace MyApp.WPFList.TagEmployee
{
    public class TagEmployeeDataContext : INotifyPropertyChanged
    {
        ...
        //old Remove later. DataContext.html holds the code. This is the original.// public ObservableCollection<ModelNotifiedForTagEmployee> modelNotifiedForTagEmployee { get; set; }

        /// <summary>
        /// Defines the main class holding Grid's data. This data is filtered/copied to "GridData" and binded to grid.
        /// </summary>
        public List<ModelNotifiedForTagEmployee> modelNotifiedForTagEmployeeMain { get; set; }

        /// <summary>
        /// Holds the data binded to Grid. 
        /// </summary>
        public ObservableCollection<ModelNotifiedForTagEmployee> GridData { get; set; }
