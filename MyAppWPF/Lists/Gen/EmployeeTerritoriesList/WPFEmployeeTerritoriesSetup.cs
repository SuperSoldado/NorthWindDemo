...
namespace MyApp.WPFList.EmployeeTerritories
{
    ...
    /// </summary>
    public partial class ListWPFEmployeeTerritories : Page
    {
        public void Setup_SetLanguage(string language)
        {           
            CurrentLanguage = language;
            WPFLanguage wPFLanguage = LanguageHelper.GetLanguageForList(language, "EmployeeTerritories");
        ...
        private void Setup_Controls(WPFLanguage language)
        {
            ...
            {
                EmployeeTerritoriesDataContext.WPFMessageAndLabelForList.LabelBtnOpenForm = languageElement.TranslatedValue;
            }
            ...
            if (languageElement != null)
            {
                EmployeeTerritoriesDataContext.WPFMessageAndLabelForList.LabelBtnDelete = languageElement.TranslatedValue;
            }
            ...
            if (languageElement != null)
            {
                EmployeeTerritoriesDataContext.WPFMessageAndLabelForList.LabelBtnSave = languageElement.TranslatedValue;
            }
            ...
            if (languageElement != null)
            {
                EmployeeTerritoriesDataContext.WPFMessageAndLabelForList.LabelBtnReload = languageElement.TranslatedValue;
            }
            ...
            if (languageElement != null)
            {
                EmployeeTerritoriesDataContext.WPFMessageAndLabelForList.LabelBtnFilter = languageElement.TranslatedValue;
            }
            ...
            if (languageElement != null)
            {
                EmployeeTerritoriesDataContext.WPFMessageAndLabelForList.LabelGroupVisibility = languageElement.TranslatedValue;
            }
            ...
            if (languageElement != null)
            {
                EmployeeTerritoriesDataContext.WPFMessageAndLabelForList.LabelGroupSearch = languageElement.TranslatedValue;
            }
        }
        ...
        private void Setup_Messages(WPFLanguage language)
        {
            ...
            if (languageElement != null)
            {
                ...
                EmployeeTerritoriesDataContext.WPFMessageAndLabelForList.MessageBoxDeleteConfirm = languageElement.TranslatedValue;
            }
            ...
            if (languageElement != null)
            {
                ...
                EmployeeTerritoriesDataContext.WPFMessageAndLabelForList.MessageBoxDeleteConfirmCaption = languageElement.TranslatedValue; 
            }
            ...
            if (languageElement != null)
            {
                ...
                EmployeeTerritoriesDataContext.WPFMessageAndLabelForList.MessageBoxDeleteOK = languageElement.TranslatedValue;
            }            
            ...
            if (languageElement != null)
            {
                ...
                EmployeeTerritoriesDataContext.WPFMessageAndLabelForList.MessageBoxSaveError = languageElement.TranslatedValue;
            }
            ...
            if (languageElement != null)
            {
                ...
                EmployeeTerritoriesDataContext.WPFMessageAndLabelForList.MessageBoxSaveOK = languageElement.TranslatedValue;
            }
        }        
        ...
        public void Setup_SetLanguage(WPFLanguage language)
        {
            ...
            foreach (var gridColumn in DataGridEmployeeTerritories.Columns)
            {
        ...
        {
            foreach (var item in DataGridEmployeeTerritories.Columns)
            {
