...
public ModelNotifiedForEmployees()
{
    this.NewItem = true;
        ...
        private Visibility _BtnAddPhotoVisibility { get; set; }
        public Visibility BtnAddPhotoVisibility
        {
            get
            {
            ...
            set 
            { 
                _BtnAddPhotoVisibility = value; 
                RaiseProperChanged();
            }
        }

        private Visibility _BtnExcludePhotoVisibility { get; set; }
        public Visibility BtnExcludePhotoVisibility
        {
            ...
            set 
            { 
                _BtnExcludePhotoVisibility = value; 
                RaiseProperChanged();
            }
        }
