...
namespace MyApp.WPFList.CustomerDemographics
{
    public class CustomerDemographicsDataContext : INotifyPropertyChanged
    {
        ...
        //old Remove later. DataContext.html holds the code. This is the original.// public ObservableCollection<ModelNotifiedForCustomerDemographics> modelNotifiedForCustomerDemographics { get; set; }

        /// <summary>
        /// Defines the main class holding Grid's data. This data is filtered/copied to "GridData" and binded to grid.
        /// </summary>
        public List<ModelNotifiedForCustomerDemographics> modelNotifiedForCustomerDemographicsMain { get; set; }

        /// <summary>
        /// Holds the data binded to Grid. 
        /// </summary>
        public ObservableCollection<ModelNotifiedForCustomerDemographics> GridData { get; set; }
