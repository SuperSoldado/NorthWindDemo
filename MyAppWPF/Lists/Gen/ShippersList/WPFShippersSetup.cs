...
namespace MyApp.WPFList.Shippers
{
    ...
    /// </summary>
    public partial class ListWPFShippers : Page
    {
        public void Setup_SetLanguage(string language)
        {           
            CurrentLanguage = language;
            WPFLanguage wPFLanguage = LanguageHelper.GetLanguageForList(language, "Shippers");
        ...
        private void Setup_Controls(WPFLanguage language)
        {
            ...
            {
                ShippersDataContext.WPFMessageAndLabelForList.LabelBtnOpenForm = languageElement.TranslatedValue;
            }
            ...
            if (languageElement != null)
            {
                ShippersDataContext.WPFMessageAndLabelForList.LabelBtnDelete = languageElement.TranslatedValue;
            }
            ...
            if (languageElement != null)
            {
                ShippersDataContext.WPFMessageAndLabelForList.LabelBtnSave = languageElement.TranslatedValue;
            }
            ...
            if (languageElement != null)
            {
                ShippersDataContext.WPFMessageAndLabelForList.LabelBtnReload = languageElement.TranslatedValue;
            }
            ...
            if (languageElement != null)
            {
                ShippersDataContext.WPFMessageAndLabelForList.LabelBtnFilter = languageElement.TranslatedValue;
            }
            ...
            if (languageElement != null)
            {
                ShippersDataContext.WPFMessageAndLabelForList.LabelGroupVisibility = languageElement.TranslatedValue;
            }
            ...
            if (languageElement != null)
            {
                ShippersDataContext.WPFMessageAndLabelForList.LabelGroupSearch = languageElement.TranslatedValue;
            }
        }
        ...
        private void Setup_Messages(WPFLanguage language)
        {
            ...
            if (languageElement != null)
            {
                ...
                ShippersDataContext.WPFMessageAndLabelForList.MessageBoxDeleteConfirm = languageElement.TranslatedValue;
            }
            ...
            if (languageElement != null)
            {
                ...
                ShippersDataContext.WPFMessageAndLabelForList.MessageBoxDeleteConfirmCaption = languageElement.TranslatedValue; 
            }
            ...
            if (languageElement != null)
            {
                ...
                ShippersDataContext.WPFMessageAndLabelForList.MessageBoxDeleteOK = languageElement.TranslatedValue;
            }            
            ...
            if (languageElement != null)
            {
                ...
                ShippersDataContext.WPFMessageAndLabelForList.MessageBoxSaveError = languageElement.TranslatedValue;
            }
            ...
            if (languageElement != null)
            {
                ...
                ShippersDataContext.WPFMessageAndLabelForList.MessageBoxSaveOK = languageElement.TranslatedValue;
            }
        }        
        ...
        public void Setup_SetLanguage(WPFLanguage language)
        {
            ...
            foreach (var gridColumn in DataGridShippers.Columns)
            {
        ...
        {
            foreach (var item in DataGridShippers.Columns)
            {
