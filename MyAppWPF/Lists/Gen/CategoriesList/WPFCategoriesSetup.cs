...
namespace MyApp.WPFList.Categories
{
    ...
    /// </summary>
    public partial class ListWPFCategories : Page
    {
        ...
        private void Setup_Controls(WPFLanguage language)
        {
            ...
            {
                CategoriesDataContext.WPFMessageAndLabelForList.LabelBtnOpenForm = languageElement.TranslatedValue;
            }
            ...
            if (languageElement != null)
            {
                CategoriesDataContext.WPFMessageAndLabelForList.LabelBtnDelete = languageElement.TranslatedValue;
            }
            ...
            if (languageElement != null)
            {
                CategoriesDataContext.WPFMessageAndLabelForList.LabelBtnSave = languageElement.TranslatedValue;
            }
            ...
            if (languageElement != null)
            {
                CategoriesDataContext.WPFMessageAndLabelForList.LabelBtnReload = languageElement.TranslatedValue;
            }
            ...
            if (languageElement != null)
            {
                CategoriesDataContext.WPFMessageAndLabelForList.LabelBtnFilter = languageElement.TranslatedValue;
            }
            ...
            if (languageElement != null)
            {
                CategoriesDataContext.WPFMessageAndLabelForList.LabelGroupVisibility = languageElement.TranslatedValue;
            }
            ...
            if (languageElement != null)
            {
                CategoriesDataContext.WPFMessageAndLabelForList.LabelGroupSearch = languageElement.TranslatedValue;
            }
        }
        ...
        private void Setup_Messages(WPFLanguage language)
        {
            ...
            if (languageElement != null)
            {
                ...
                CategoriesDataContext.WPFMessageAndLabelForList.MessageBoxDeleteConfirm = languageElement.TranslatedValue;
            }
            ...
            if (languageElement != null)
            {
                ...
                CategoriesDataContext.WPFMessageAndLabelForList.MessageBoxDeleteConfirmCaption = languageElement.TranslatedValue; 
            }
            ...
            if (languageElement != null)
            {
                ...
                CategoriesDataContext.WPFMessageAndLabelForList.MessageBoxDeleteOK = languageElement.TranslatedValue;
            }            
            ...
            if (languageElement != null)
            {
                ...
                CategoriesDataContext.WPFMessageAndLabelForList.MessageBoxSaveError = languageElement.TranslatedValue;
            }
            ...
            if (languageElement != null)
            {
                ...
                CategoriesDataContext.WPFMessageAndLabelForList.MessageBoxSaveOK = languageElement.TranslatedValue;
            }
        }        
        ...
        public void Setup_SetLanguage(WPFLanguage language)
        {
            ...
            foreach (var gridColumn in DataGridCategories.Columns)
            {
        ...
        {
            foreach (var item in DataGridCategories.Columns)
            {
