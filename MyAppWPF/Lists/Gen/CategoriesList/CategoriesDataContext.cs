...
namespace MyApp.WPFList.Categories
{
    public class CategoriesDataContext : INotifyPropertyChanged
    {
        ...
        //old Remove later. DataContext.html holds the code. This is the original.// public ObservableCollection<ModelNotifiedForCategories> modelNotifiedForCategories { get; set; }

        /// <summary>
        /// Defines the main class holding Grid's data. This data is filtered/copied to "GridData" and binded to grid.
        /// </summary>
        public List<ModelNotifiedForCategories> modelNotifiedForCategoriesMain { get; set; }

        /// <summary>
        /// Holds the data binded to Grid. 
        /// </summary>
        public ObservableCollection<ModelNotifiedForCategories> GridData { get; set; }
