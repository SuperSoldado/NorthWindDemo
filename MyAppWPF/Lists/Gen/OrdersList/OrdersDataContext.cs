...
namespace MyApp.WPFList.Orders
{
    public class OrdersDataContext : INotifyPropertyChanged
    {
        ...
        //old Remove later. DataContext.html holds the code. This is the original.// public ObservableCollection<ModelNotifiedForOrders> modelNotifiedForOrders { get; set; }

        /// <summary>
        /// Defines the main class holding Grid's data. This data is filtered/copied to "GridData" and binded to grid.
        /// </summary>
        public List<ModelNotifiedForOrders> modelNotifiedForOrdersMain { get; set; }

        /// <summary>
        /// Holds the data binded to Grid. 
        /// </summary>
        public ObservableCollection<ModelNotifiedForOrders> GridData { get; set; }
