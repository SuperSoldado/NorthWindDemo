...
namespace MyApp.WPFList.Orders
{
    ...
    /// </summary>
    public partial class ListWPFOrders : Page
    {
        public void Setup_SetLanguage(string language)
        {           
            CurrentLanguage = language;
            WPFLanguage wPFLanguage = LanguageHelper.GetLanguageForList(language, "Orders");
        ...
        private void Setup_Controls(WPFLanguage language)
        {
            ...
            {
                OrdersDataContext.WPFMessageAndLabelForList.ComboDateBetween = languageElement.TranslatedValue;
            }
            ...
            if (languageElement != null)
            {
                OrdersDataContext.WPFMessageAndLabelForList.LabelBtnOpenForm = languageElement.TranslatedValue;
            }
            ...
            if (languageElement != null)
            {
                OrdersDataContext.WPFMessageAndLabelForList.LabelBtnDelete = languageElement.TranslatedValue;
            }
            ...
            if (languageElement != null)
            {
                OrdersDataContext.WPFMessageAndLabelForList.LabelBtnSave = languageElement.TranslatedValue;
            }
            ...
            if (languageElement != null)
            {
                OrdersDataContext.WPFMessageAndLabelForList.LabelBtnReload = languageElement.TranslatedValue;
            }
            ...
            if (languageElement != null)
            {
                OrdersDataContext.WPFMessageAndLabelForList.LabelBtnFilter = languageElement.TranslatedValue;
            }
            ...
            if (languageElement != null)
            {
                OrdersDataContext.WPFMessageAndLabelForList.LabelGroupVisibility = languageElement.TranslatedValue;
            }
            ...
            if (languageElement != null)
            {
                OrdersDataContext.WPFMessageAndLabelForList.LabelGroupSearch = languageElement.TranslatedValue;
            }
        }
        ...
        private void Setup_Messages(WPFLanguage language)
        {
            ...
            if (languageElement != null)
            {
                ...
                OrdersDataContext.WPFMessageAndLabelForList.MessageBoxDeleteConfirm = languageElement.TranslatedValue;
            }
            ...
            if (languageElement != null)
            {
                ...
                OrdersDataContext.WPFMessageAndLabelForList.MessageBoxDeleteConfirmCaption = languageElement.TranslatedValue; 
            }
            ...
            if (languageElement != null)
            {
                ...
                OrdersDataContext.WPFMessageAndLabelForList.MessageBoxDeleteOK = languageElement.TranslatedValue;
            }            
            ...
            if (languageElement != null)
            {
                ...
                OrdersDataContext.WPFMessageAndLabelForList.MessageBoxSaveError = languageElement.TranslatedValue;
            }
            ...
            if (languageElement != null)
            {
                ...
                OrdersDataContext.WPFMessageAndLabelForList.MessageBoxSaveOK = languageElement.TranslatedValue;
            }
        }        
        ...
        public void Setup_SetLanguage(WPFLanguage language)
        {
            ...
            foreach (var gridColumn in DataGridOrders.Columns)
            {
        ...
        {
            foreach (var item in DataGridOrders.Columns)
            {
