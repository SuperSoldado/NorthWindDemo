...
namespace MyApp.WPFList.Customers
{
    ...
    /// </summary>
    public partial class ListWPFCustomers : Page
    {
        public void Setup_SetLanguage(string language)
        {           
            CurrentLanguage = language;
            WPFLanguage wPFLanguage = LanguageHelper.GetLanguageForList(language, "Customers");
        ...
        private void Setup_Controls(WPFLanguage language)
        {
            ...
            {
                CustomersDataContext.WPFMessageAndLabelForList.LabelBtnOpenForm = languageElement.TranslatedValue;
            }
            ...
            if (languageElement != null)
            {
                CustomersDataContext.WPFMessageAndLabelForList.LabelBtnDelete = languageElement.TranslatedValue;
            }
            ...
            if (languageElement != null)
            {
                CustomersDataContext.WPFMessageAndLabelForList.LabelBtnSave = languageElement.TranslatedValue;
            }
            ...
            if (languageElement != null)
            {
                CustomersDataContext.WPFMessageAndLabelForList.LabelBtnReload = languageElement.TranslatedValue;
            }
            ...
            if (languageElement != null)
            {
                CustomersDataContext.WPFMessageAndLabelForList.LabelBtnFilter = languageElement.TranslatedValue;
            }
            ...
            if (languageElement != null)
            {
                CustomersDataContext.WPFMessageAndLabelForList.LabelGroupVisibility = languageElement.TranslatedValue;
            }
            ...
            if (languageElement != null)
            {
                CustomersDataContext.WPFMessageAndLabelForList.LabelGroupSearch = languageElement.TranslatedValue;
            }
        }
        ...
        private void Setup_Messages(WPFLanguage language)
        {
            ...
            if (languageElement != null)
            {
                ...
                CustomersDataContext.WPFMessageAndLabelForList.MessageBoxDeleteConfirm = languageElement.TranslatedValue;
            }
            ...
            if (languageElement != null)
            {
                ...
                CustomersDataContext.WPFMessageAndLabelForList.MessageBoxDeleteConfirmCaption = languageElement.TranslatedValue; 
            }
            ...
            if (languageElement != null)
            {
                ...
                CustomersDataContext.WPFMessageAndLabelForList.MessageBoxDeleteOK = languageElement.TranslatedValue;
            }            
            ...
            if (languageElement != null)
            {
                ...
                CustomersDataContext.WPFMessageAndLabelForList.MessageBoxSaveError = languageElement.TranslatedValue;
            }
            ...
            if (languageElement != null)
            {
                ...
                CustomersDataContext.WPFMessageAndLabelForList.MessageBoxSaveOK = languageElement.TranslatedValue;
            }
        }        
        ...
        public void Setup_SetLanguage(WPFLanguage language)
        {
            ...
            foreach (var gridColumn in DataGridCustomers.Columns)
            {
        ...
        {
            foreach (var item in DataGridCustomers.Columns)
            {
