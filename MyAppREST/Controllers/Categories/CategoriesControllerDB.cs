...
{
    public class RESTCategoriesDB : RESTBaseDB
    {
        ...
        public void TryDelete(DeleteCategoriesView viewToDelete, out RestExceptionError error)
        {
            error = null;
            CategoriesInfo dbViewToDelete = new CategoriesInfo();
            try
            {
                Cloner.CopyAllTo(typeof(DeleteCategoriesView), viewToDelete, typeof(CategoriesInfo), dbViewToDelete);
            }
            catch (Exception ex)
            {
                error = new RestExceptionError();
                error.InternalMessage = "Internal Error parsing data for (Categories.TryDelete/Parsing)";
            ...
            try
            {
                ...
                {
                    error = new RestExceptionError();
                    error.InternalMessage = "Internal Error Save data for [Categories.TryDelete]";
            ...
            {
                error = new RestExceptionError();
                error.InternalMessage = "Internal Error Update data for [Categories.TryDelete]";
                error.ExceptionMessage = ex.Message;
                error.SourceError = RestExceptionError._SourceError.ServerSide;
                error.StackTrace = ex.StackTrace;
            }
        ...
        public void TryInclude(CreateCategoriesView viewToInclude, out RestExceptionError error)
        {
            error = null;
            CategoriesInfo dbViewToInclude = new CategoriesInfo();
            try
            {                
                Cloner.CopyAllTo(typeof(CreateCategoriesView), viewToInclude, typeof(CategoriesInfo), dbViewToInclude);                
            }
            catch (Exception ex)
            {
                error = new RestExceptionError();
                error.InternalMessage = "Internal Error parsing data for (Categories.TryInclude/Parsing)";
                error.ExceptionMessage = ex.Message;
                error.SourceError = RestExceptionError._SourceError.ServerSide;
                error.StackTrace = ex.StackTrace;
            }
            ...
            try
            {
                ...
                {
                    error = new RestExceptionError();
                    error.InternalMessage = "Internal Error Save data for [Categories.TryInclude/Save]";
                    error.ExceptionMessage = dbError;
                    error.SourceError = RestExceptionError._SourceError.ServerSide;
                    error.StackTrace = "";
                }
        ...
        public T TryParse<T>(GeneralBodyPost generalBodyPost, out RestExceptionError error)
        {
            ...
            {
                error = new RestExceptionError();
                error.InternalMessage = "No data from client to include [Categories.TryParse]";
                error.ExceptionMessage = "No data";
                error.SourceError = RestExceptionError._SourceError.ClientSide;
                error.StackTrace = "RESTCategoriesDB.TryParse";
                return default(T);
            }
            ...
            catch (Exception ex)
            {
                ...
                error.ExceptionMessage = ex.Message;
                error.SourceError = RestExceptionError._SourceError.ClientSide;
                error.InternalMessage = "Error parsing data from body to view for [Categories.TryParse]";
                return default(T);
            }            
        }
        ...
        /// </summary>
        public List<GetCategoriesView> Filter(List<GetCategoriesView> rawList, GeneralBodyGet GeneralBodyGet, out RestExceptionError error)
        {
            try
            {
                error = null;
                ...
                List<GetCategoriesView> result = null;
                if (linqQuery != null)
                {
                ...
                else
                {
                    ...
                    result = filteredList.Cast<GetCategoriesView>().ToList();
                }
        ...
        /// Examples:
        /// "Where(GetAllCategoriesView => (GetAllCategoriesView.CategoriesID = 4))"
        /// </summary>
        /// <param name="list"></param>
        /// <param name="GeneralBodyGet"></param>
        /// <param name="error"></param>
        /// <returns></returns>
        public List<GetCategoriesView> DynamicLinqQuery(List<GetCategoriesView> list, string linqQuery, out RestExceptionError error)
        {
            try
            {
                error = null;

                IQueryable<GetCategoriesView> queryableData = list.AsQueryable<GetCategoriesView>();
                var externals = new Dictionary<string, object>();
                externals.Add("list", queryableData);
                string query = "list." + linqQuery;//Example: "list.Where(GetCategoriesView => (GetCategoriesView.CategoriesID = 4))";
                var expression = System.Linq.Dynamic.DynamicExpression.Parse(typeof(IQueryable<GetCategoriesView>), query, new[] { externals });
                var result = queryableData.Provider.CreateQuery<GetCategoriesView>(expression);
        ...
        public List<GetCategoriesView> OrderByAndTrim(List<GetCategoriesView> list, GeneralBodyGet GeneralBodyGet, out RestExceptionError error)
        {
            try
            {
                error = null;
                ...
                List<GetCategoriesView> filteredList = null;
                //1)Ordering
